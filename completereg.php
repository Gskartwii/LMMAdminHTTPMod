<?php
	...
	if (mysql_fetch_array($r))
		...
		echo mysql_error();
		mysql_query("CREATE TABLE IF NOT EXISTS roblox_placeids_$un (id int(11) NOT NULL AUTO_INCREMENT, placeid int(11) NOT NULL, placename VARCHAR(255) NOT NULL, placedesc TEXT NOT NULL, placecreator VARCHAR(100) NOT NULL, PRIMARY KEY (id), KEY id (id))");
		echo mysql_error();
