--[[
Here, you adjust settings. Do not touch semicolons(;) unless it's the Prefix inside the quotes.
--]]
...
local Elements = {
	...
	Ranks = {
		...
		["Admin"] = {"BestFriend", "RyanDolan123"}; -- Most commands, can kick, ban, crash, and has power in servers
