<?php
	...
	if (!$builder || !$placename) die("Invalid placeid: \$builder or \$placename where not set. Check the placeid. <a href='configplace.php'>Go back to my places</a>");
	...
	echo mysql_error();
	echo "Your place has been added to the database. <a href='configplace.php'>Go back to my places</a>";
?>